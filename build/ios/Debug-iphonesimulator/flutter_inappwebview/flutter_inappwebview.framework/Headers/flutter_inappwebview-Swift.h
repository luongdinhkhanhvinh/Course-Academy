...
@interface FlutterWebViewController : FlutterMethodCallDelegate <FlutterPlatformView>
...
@interface InAppBrowserWebViewController : UIViewController <FlutterPlugin, UIScrollViewDelegate, UITextFieldDelegate, WKUIDelegate>
...
SWIFT_CLASS("_TtC20flutter_inappwebview22InAppWebView_IBWrapper")
@interface InAppWebView_IBWrapper : UIView
